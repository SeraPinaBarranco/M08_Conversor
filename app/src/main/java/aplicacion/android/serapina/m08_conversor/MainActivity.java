package aplicacion.android.serapina.m08_conversor;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // index1 = Integer.parseInt(spn_div1.getSelectedItem().toString());
              //  index2 = Integer.parseInt(spn_div2.getSelectedItem().toString());
            try{
 ...
 /*  public double calcs(int pos,int pos2, boolean multipli){
        index1 = pos;
        index2 = pos2;
        ...
        if(multipli == true){//si pasan valor verdadero multiplica el tesultado
            //Calculo de la conversion
            res = n1 * t[pos][pos2];
        }else{//si no pasan valor verdadero divide resultado
            res = n1 / t[index1][index2];
        }
